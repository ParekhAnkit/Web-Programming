...
(function () {
    ...
    function isPalindrome(text) {
        ...
        if (text == text.split("").reverse().join("")) {
            ...
            throw "String is not palindrome";
        }
    }
        ...
        staticForm.addEventListener("submit", event => {
            ...
            Object.keys(palindromList).forEach(function (key) {
                if (palindromList[key] == 1) {
                    outputString =
                        outputString + "<div class='is-palindrome'><font color='blue'>" + key + "</font></div>";
                } else if (palindromList[key] == 0) {
                    outputString =
                        outputString + "<div class='not-palindrome'><font color='red'>" + key + "</font></div>";
                }
            });
            $("#history").html(outputString);
